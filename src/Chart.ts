            ...
            case 'kml':
                if (!integrate) {
                    return this.timeSeriesData().map(jsonList => {
                        ...
                        return `<?xml version="1.0" encoding="UTF-8"?><kml xmlns="http://www.opengis.net/kml/2.2"><Document><name>Trajectory</name><description>(c)2023 Tomoya Onuki. Generated by https://tomoya-onuki.github.io/locationDataGenerator/</description><Style id="line"><LineStyle><color>${color}</color><width>3</width></LineStyle></Style><Placemark><name>Trajectory</name><description>(c)2023 Tomoya Onuki. Generated by https://tomoya-onuki.github.io/locationDataGenerator/</description><TimeSpan><begin>${beginDate}</begin><end>${endDate}</end></TimeSpan><styleUrl>#line</styleUrl><LineString><extrude>1</extrude><tessellate>1</tessellate><altitudeMode>absolute</altitudeMode><coordinates>${xmlCoord}</coordinates></LineString></Placemark></Document></kml>`;
                    });
                } else {
                    let xmlPlace: string = '';
                    let xmlStyle: string = '';
                    ...
                    this.timeSeriesData().forEach((jsonList, i) => {
                        ...
                        xmlPlace += `<Placemark><name>Trajectory ${i}</name><description>(c)2023 Tomoya Onuki. Generated by https://tomoya-onuki.github.io/locationDataGenerator/</description><TimeSpan><begin>${beginDate}</begin><end>${endDate}</end></TimeSpan><styleUrl>#line${i}</styleUrl><LineString><extrude>1</extrude><tessellate>1</tessellate><altitudeMode>absolute</altitudeMode><coordinates>${xmlCoord}</coordinates></LineString></Placemark>`;
                    });
                    return [`<?xml version="1.0" encoding="UTF-8"?><kml xmlns="http://www.opengis.net/kml/2.2"><Document><name>Trajectory</name><description>(c)2023 Tomoya Onuki. Generated by https://tomoya-onuki.github.io/locationDataGenerator/</description>${xmlStyle}${xmlPlace}</Document></kml>`];
                }
            case 'gpx':
                if (!integrate) {
                    return this.timeSeriesData().map(jsonList => {
